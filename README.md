# Командный проект "Автопарк"

## Описание

Проект Автопарк осуществляет обслуживание заказов на перевозку грузов, используя свой парк автомобилей и водителей. Водитель, выполнивший заказ, получает 20% от стоимости перевозки.
